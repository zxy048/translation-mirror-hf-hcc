...
p <- ggplot() +
  ...
  annotate("text", x=0.5, y=0.90, label="Shared architecture, opposed direction, distinct drivers",
           size=4, color="grey50") +
  ...
  annotate("text", x=0.74, y=0.82, label="Dilated / Ischemic CMP", size=4.5, color=blue) +
  ...
  # Middle: ssGSEA -> WGCNA
  annotate("segment", x=0.50, xend=0.50, y=0.525, yend=0.495, arrow=arrow(length=unit(0.05,"npc")), color=purp, linewidth=1) +

...
# Title
p <- p + annotate("text", x=0.50, y=0.96, label="Cross-Disease Transcriptomic Analysis of Translation Co-expression Programs", fontface="bold", size=7, color="grey20")
...
p <- p + annotate("text", x=0.50, y=0.11, label="Perturbation direction is disease-specific, associated with distinct upstream regulators (ATF4/ISR + MYC)", size=3.8, color="#C62828")

...
datExpr0 <- datExpr0[, order(vars, decreasing = TRUE)[1:min(5000, ncol(datExpr0))]]
...
# 4. 输出图
png(file.path(PROJ_DIR, "figures", "Figure_S1_SoftThreshold_GSE57338.png"),
...
cat("→ figures/Figure_S1_SoftThreshold_GSE57338.png saved\n")
